...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  1 green dot.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(100, 50), 25)
    draw_points_on_circle(window, circle, 1, 'green')
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'POLYGON test 3:  4 segments with black lines, green filled circle.'
    window = rg.RoseWindow(550, 400, title)
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  300 red lines on black circle, hops = 61.'
