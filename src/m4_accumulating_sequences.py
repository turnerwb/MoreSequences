...
def run_test_make_simple_list():
    ...
    # Test 3:
    expected = [100]
    actual = make_simple_list(100, 100)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    # Test 2:
    expected = "100-"
    actual = make_simple_string(100, 100)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = "100"
    actual = make_less_simple_string(100, 100)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def draw_shapes(shapes, window):
    ...
    window.render(.3)  # Just a note, is there something that can be done to get rid of the weak warning here??
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        rectangles += [circles[k].get_bounding_box()]
    return rectangles
